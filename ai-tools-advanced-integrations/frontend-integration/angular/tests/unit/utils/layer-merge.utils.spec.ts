...
import { mergeLayerSpecs, validateLayerColumns } from '../../../src/app/utils/layer-merge.utils';
...
describe('mergeLayerSpecs', () => {
  ...
  it('should deep merge existing layers by ID', () => {
  ...
  it('should preserve layers not in incoming', () => {
  ...
  it('should return existing layers when incoming is empty', () => {
    const existing = [{ id: 'a', color: 'red' }];
  ...
  it('should return incoming layers when existing is empty', () => {
    const incoming = [{ id: 'b', color: 'blue' }];
  ...
  it('should skip layers without an id property', () => {
    const existing = [{ id: 'a', color: 'red' }];
  ...
  it('should deep merge 3+ levels of nesting', () => {
  ...
  it('should overwrite arrays instead of concatenating', () => {
  ...
  it('should overwrite target value with null from source', () => {
...
describe('validateLayerColumns', () => {
  it('should not warn when all referenced columns are present', () => {
  ...
  it('should warn when a referenced column is missing from data.columns', () => {
    const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
    validateLayerColumns({
      id: 'test',
  ...
  it('should not warn when accessor lacks @@= prefix', () => {
    const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
    validateLayerColumns({
      id: 'test',
      getFillColor: 'properties.revenue > 1000 ? [255,0,0] : [0,0,255]',
  ...
  it('should extract columns from all 4 accessor properties', () => {
    const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
    validateLayerColumns({
      id: 'test',
  ...
  it('should not warn when accessors are not strings', () => {
    const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
    validateLayerColumns({
      id: 'test',
  ...
  it('should handle layer with no data property', () => {
    const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
    validateLayerColumns({
      id: 'test',
  ...
  it('should deduplicate column references across accessors', () => {
    const warnSpy = vi.spyOn(console, 'warn').mockImplementation(() => {});
    validateLayerColumns({
      id: 'test',
