...
describe('extractDiscreteColors', () => {
  ...
  it('returns empty entries for null/undefined', () => {
    expect(extractDiscreteColors(null).entries).toHaveLength(0);
    expect(extractDiscreteColors(undefined).entries).toHaveLength(0);
  });
...
describe('extractColorFunctionConfig', () => {
  it('returns null for null input', () => {
    expect(extractColorFunctionConfig(null)).toBeNull();
  });
...
describe('extractLegendFromLayer', () => {
  it('returns null for null layer', () => {
    expect(extractLegendFromLayer(null)).toBeNull();
  });
