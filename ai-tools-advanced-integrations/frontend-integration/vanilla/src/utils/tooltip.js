...
const EXCLUDED_COLUMNS = new Set([
  'geom', 'geometry', 'the_geom', 'the_geom_webmercator', 'shape',
  'wkb_geometry', 'geo',
  'id', 'osm_id', 'cartodb_id', 'ogc_fid', 'gid', 'fid', 'objectid',
  'globalid', 'geoid',
  'h3', 'quadbin', 'geohash',
...
const getTooltipProperties = (properties) => {
 ...
 */
export const getTooltipContent = (info) => {
  if (!info.picked || !info.object) {
    return null;
  }

  const properties = extractProperties(info.object);
