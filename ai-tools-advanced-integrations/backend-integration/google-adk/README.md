...
```bash
pnpm install --force    # --force needed for peer dependency conflicts
```
...
pnpm run poc        # Run ADK prototype script
pnpm run poc:stream # Run ADK streaming prototype script
```
