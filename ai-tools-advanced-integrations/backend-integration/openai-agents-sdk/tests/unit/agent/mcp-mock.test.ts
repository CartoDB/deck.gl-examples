...
describe('initializeMCPClients (mock mode)', () => {
  ...
  it('populates mcpToolCache with 4 mock tools', async () => {
  ...
  it('getMCPStatus returns servers: ["mock"] in mock mode', async () => {
  ...
  it('isMCPInitialized returns true after mock initialization', async () => {
